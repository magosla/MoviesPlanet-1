...
public class Config {
    public static final String MOVIEDB_API_KEY = BuildConfig.MOVIEDB_API_KEY;  // themoviedb.org Developer's API key
    ...
    public static final String MOVIEDB_BASE_URL = "https://api.themoviedb.org/3/movie?language=en-US";
